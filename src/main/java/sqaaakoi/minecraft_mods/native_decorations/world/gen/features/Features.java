...
public class Features {
  ...
  public static final RegistryKey<ConfiguredFeature<?, ?>> key_placed_cobblestone_rock = RegistryKey.of(Registry.PLACED_FEATURE_KEY, new Identifier(Main.ID, "cobblestone_rock"));
