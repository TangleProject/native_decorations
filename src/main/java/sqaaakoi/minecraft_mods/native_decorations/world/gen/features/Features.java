...
public class Features {
  ...
  private static final Feature<RockFeatureConfig> feature_log_pile = new LogPileFeature(LogPileFeatureConfig.CODEC);
  ...
  public static final ConfiguredFeature<?, ?> configured_oak_log_pile = feature_log_pile.configure(new LogPileFeature(ConstantIntProvider.create(3), ConstantIntProvider.create(5), new SimpleBlockStateProvider(Blocks.oak_log_pile.getDefaultState().with(LogPileBlock.AXIS, Direction.Axis.X)), new SimpleBlockStateProvider(Blocks.oak_log_pile.getDefaultState().with(LogPileBlock.AXIS, Direction.Axis.X))));
