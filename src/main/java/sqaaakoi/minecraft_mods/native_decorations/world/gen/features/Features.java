...
public class Features {
  ...
  public static final PlacedFeature placed_oak_log_pile = configured_oak_log_pile.withPlacement(HeightmapPlacementModifier.of(Heightmap.Type.OCEAN_FLOOR_WG), RarityFilterPlacementModifier.of(5));
